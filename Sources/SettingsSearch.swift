...
enum SettingsIndex {
    ...
    static let all: [SettingEntry] = [
        ...
        e(.widgets, "File Shelf", "Keep the Shelf open until you close it", "shelf stay open sticky close click away disappear pin"),
        ...
        e(.optimize, "Overview", "Clean every week", "automatic auto clean weekly schedule caches"),
        e(.optimize, "Clean", "Clean caches and logs", "clean cache caches logs junk temporary files free space trash cleaner"),
        e(.optimize, "Clean", "Xcode build files", "xcode deriveddata developer simulator build"),
        e(.optimize, "Clean", "Empty Trash", "empty trash delete"),
        e(.optimize, "Maintain", "Flush DNS cache", "dns flush network internet websites not loading"),
        e(.optimize, "Maintain", "Free up memory", "purge ram memory free up"),
        e(.optimize, "Maintain", "Rebuild Open With menu", "launch services open with duplicate apps default app lsregister"),
        e(.optimize, "Maintain", "Rebuild Spotlight index", "spotlight index search reindex mdutil"),
        e(.optimize, "Maintain", "Reset Quick Look", "quick look preview thumbnails qlmanage"),
        e(.optimize, "Maintain", "Clear font caches", "fonts font cache garbled"),
        e(.optimize, "Maintain", "Restart Finder, Dock or menu bar", "restart relaunch finder dock menu bar control center stuck"),
        e(.optimize, "Maintain", "Check startup disk", "disk verify first aid errors diskutil"),
        e(.optimize, "Tweaks", "Show hidden files", "hidden files dotfiles finder show invisible"),
        e(.optimize, "Tweaks", "Show all file extensions", "extensions file extension finder"),
        e(.optimize, "Tweaks", "Finder path bar and status bar", "finder path bar status bar"),
        e(.optimize, "Tweaks", "No .DS_Store files", "ds_store dsstore network usb drives"),
        e(.optimize, "Tweaks", "Dock speed", "dock auto hide autohide speed delay animation instant"),
        e(.optimize, "Tweaks", "Hide recent apps in Dock", "dock recent apps recents"),
        e(.optimize, "Tweaks", "Screenshot format and location", "screenshot format png jpg heic location folder shadow date"),
        e(.optimize, "Tweaks", "Faster animations", "speed faster animations windows mission control resize"),
        e(.optimize, "Tweaks", "Key repeat speed", "key repeat keyboard speed delay press and hold accent"),
        ...
        e(.optimize, "Startup", "Memory limit per app", "ram memory limit cap max apps using too much slider warn quit heavy"),
